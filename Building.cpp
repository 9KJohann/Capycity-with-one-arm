...
Building::Building(int basePrice, char label, char *name, std::map<Material *, int> materials, int capacity) : _basePrice(basePrice),
                                                                                                               _label(label), _name(name),
                                                                                                               _materials(materials), _capacity(capacity) {}
...
WaterEnergyPlant::WaterEnergyPlant() : Building(1, 'W', "Wasserkraftwerk",
                                                {{Wood::getInstance(), 4}, {Plastic::getInstance(), 3}, {Metal::getInstance(), 4}}, 9887) {}
...
SolarEnergyPlant::SolarEnergyPlant() : Building(1, 'S', "Solarpanele",
                                                {{Wood::getInstance(), 1}, {Plastic::getInstance(), 9}, {Metal::getInstance(), 3}}, 4862) {}
...
WindEnergyPlant::WindEnergyPlant() : Building(1, 'A', "Windkraftwerk",
                                              {{Wood::getInstance(), 7}, {Plastic::getInstance(), 3}, {Metal::getInstance(), 2}}, 6409) {}
